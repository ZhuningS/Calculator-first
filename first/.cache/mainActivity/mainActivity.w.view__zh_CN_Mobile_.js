...
var __parent0=require('$model/UI2/first/mainActivity'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cqY3Mzu';
	this._flag_='1a0f98e3cd659b8a54f1d30788d8bdda';
	this._wCfg_={};
	this._appCfg_={};
